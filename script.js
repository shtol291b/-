function myfunc() {
    ...
    if (b1.toLowerse() == 'o' && b2.toLowerse() == 'o' && b3.toLowerse() == 'o') {
        window.alert('You are a winner');
        reset();
    } else if (b4.toLowerse() == 'o' && b5.toLowerse() == 'o' && b6.toLowerse() == 'o') {
        window.alert('You are a winner');
        reset();
    }else if (b7.toLowerse() == 'o' && b8.toLowerse() == 'o' && b9.toLowerse() == 'o') {
        window.alert('You are a winner');
        reset();
    }else if (b1.toLowerse() == 'o' && b4.toLowerse() == 'o' && b7.toLowerse() == 'o') {
        window.alert('You are a winner');
        reset();
    }else if (b2.toLowerse() == 'o' && b5.toLowerse() == 'o' && b8.toLowerse() == 'o') {
        window.alert('You are a winner');
        reset();
    }else if (b3.toLowerse() == 'o' && b6.toLowerse() == 'o' && b9.toLowerse() == 'o') {
        window.alert('You are a winner');
        reset();
    }else if (b1.toLowerse() == 'o' && b5.toLowerse() == 'o' && b9.toLowerse() == 'o') {
        window.alert('You are a winner');
        reset();
    }else if (b3.toLowerse() == 'o' && b5.toLowerse() == 'o' && b7.toLowerse() == 'o') {
        window.alert('You are a winner');
        reset();
    }
}
